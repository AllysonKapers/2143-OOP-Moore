...
//
// Discription:
//    This assignment overloads operators to compare the data in nodes without having to 
//    use pointers when using the operators.
//
/////////////////////////////////////////////////////////////////////////////////
#include <iostream>
...
struct Node {
  ...
  *
  *description:
  *   Allows us to compare nodes data directly to determine if one is less than the other
  *
  *Parameters:
  ...
  *
  *description:
  *   Allows us to compare nodes data directly to determine if one is grater than the other
  *
  *Parameters:
  *   const Node& : a node object
  *
  ...
  *
  *description:
  *   Allows us to compare nodes data directly to determine if one is the same as the other
  *
  *Parameters:
  *   const Node& : a node object
  *
  ...
  *
  *description:
  *   Allows us to compare nodes data directly to determine if one is not the 
  *   same as the other.
  *
  *Parameters:
  *   const Node& : a node object
